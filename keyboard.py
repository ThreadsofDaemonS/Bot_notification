...
class Keyboard:
    ...
    def menu(self):
        ...
        Questions = types.InlineKeyboardButton(text="Питання та відповіді", callback_data="questions")
        Data = types.InlineKeyboardButton(text="Особисті данні", callback_data="profile")
